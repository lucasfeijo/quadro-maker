...
const component: ComponentSpec = {
  ...
  ports: [
    ...
    { id: 'com-11', label: 'COM', side: 'top', offsetXMm: 9, type: 'any' },
    { id: 'nc-12', label: 'NC', side: 'bottom', offsetXMm: 9, type: 'any' },
    { id: 'no-14', label: 'NO', side: 'bottom', offsetXMm: 13.5, type: 'any' },
  ],
  portDescriptions: {
