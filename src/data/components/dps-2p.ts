...
const component: ComponentSpec = {
  ...
  ports: [
    ...
    { id: 'in-N', label: 'N', side: 'top', offsetXMm: 27, type: 'neutral' },
    { id: 'out-PE1', label: 'PE', side: 'bottom', offsetXMm: 9, type: 'ground' },
    { id: 'out-PE2', label: 'PE', side: 'bottom', offsetXMm: 27, type: 'ground' },
  ],
  portDescriptions: {
