...
const component: ComponentSpec = {
  ...
  icon: 'timer',
  ports: [
    { id: 'in-A1', label: 'A1', side: 'top', offsetXMm: 6, type: 'any' },
    { id: 'in-A2', label: 'A2', side: 'bottom', offsetXMm: 6, type: 'any' },
    { id: 'out-15', label: 'COM', side: 'top', offsetXMm: 12, type: 'any' },
    { id: 'out-18', label: 'NO', side: 'bottom', offsetXMm: 12, type: 'any' },
  ],
  portDescriptions: {
